...
Route::middleware(['auth:sanctum', 'is_admin'])->group(function () {
    ...
    Route::get('/admin/detail-pengurus/{id}', [PengurusManagementController::class, 'show']);
    Route::post('/admin/pengurus', [PengurusManagementController::class, 'store']);
    ...
    Route::post('/admin/lama-angsuran', [LamaAngsuranController::class, 'store']);
    Route::get('/admin/lama-angsuran/{id}', [LamaAngsuranController::class, 'show']);
